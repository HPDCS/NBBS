...
#TARGET = $(TEST)-ptmalloc3  $(TEST)-libc $(TEST)-1lvl-nb $(TEST)-1lvl-sl $(TEST)-4lvl-nb $(TEST)-4lvl-sl $(TEST)-buddy-sl
TARGET = $(TEST)-libc $(TEST)-1lvl-nb $(TEST)-1lvl-sl $(TEST)-4lvl-nb $(TEST)-4lvl-sl $(TEST)-buddy-sl
